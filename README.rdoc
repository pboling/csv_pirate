...
Add whatever methods you want to the booty array.  Write new methods, adn add them!  Make lots of glorious CSVs full of data to impress the pointy ones in the office.
